...
const outputs = [
  {
    input: `private_set_intersection/javascript/src/combined_wasm_node.ts`,
    onwarn(warning, warn) {
    ...
    output: {
      file: `private_set_intersection/javascript/dist/combined_wasm_node.js`,
      sourcemap: true,
      format: 'cjs',
      name: 'PSI',
      exports: 'auto',
    ...
    plugins: [
      ...
      replace({
        "return this || window || global || self ||": "return this || global ||",
        delimiters: ['', ''],
  ...
  {
    input: `private_set_intersection/javascript/src/combined_wasm_web.ts`,
    onwarn(warning, warn) {
      // suppress eval warnings from google-protobuf
      if (warning.code === 'EVAL') return
      warn(warning)
    ...
    output: {
      file: `private_set_intersection/javascript/dist/combined_wasm_web.js`,
      sourcemap: true,
      format: 'umd',
      name: 'PSI',
      exports: 'auto',
  ...
  {
    input: `private_set_intersection/javascript/src/combined_wasm_worker.ts`,
    onwarn(warning, warn) {
      // suppress eval warnings from google-protobuf
      if (warning.code === 'EVAL') return
      warn(warning)
    ...
    output: {
      file: `private_set_intersection/javascript/dist/combined_wasm_worker.js`,
      sourcemap: true,
      format: 'umd',
      name: 'PSI',
      exports: 'auto',
