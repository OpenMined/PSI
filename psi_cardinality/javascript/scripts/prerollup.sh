...
cp -rf bazel-out/wasm-opt/bin/psi_cardinality/javascript/psi_cardinality_combined_js.js psi_cardinality/javascript/bin/
cp -rf bazel-out/wasm-opt/bin/psi_cardinality/javascript/psi_cardinality_combined_wasm.js psi_cardinality/javascript/bin/
